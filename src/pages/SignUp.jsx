    ...
    <div className="min-h-screen py-40 flex flex-col items-center justify-center bg-black  px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg- rounded-2xl shadow-2xl overflow-hidden p-8 sm:p-10 border border-[#faa307]">
        <div className="text-center mb-8">
          ...
          <p className="mt-3 text-sm text-gray-400">Join Fiit Life and unlock exclusive features</p>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                } bg-white/10 rounded-2xl shadow-sm placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition-all duration-200`}
                placeholder="Fiit Life"
              />
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-black text-gray-300">Or sign up with</span>
            </div>
          </div>
